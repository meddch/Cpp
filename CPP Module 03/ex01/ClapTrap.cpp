...
/*   Updated: 2023/08/13 10:37:03 by mechane          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (_Hit_point == 100)
        std::cout << "ClapTrap can't be repaired any further. Its hit points are already at the maximum value : " << _Hit_point << std::endl ;
	else
	{
		if (_Energy_point == 0)

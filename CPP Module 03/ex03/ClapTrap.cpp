...
/*   Updated: 2023/08/13 10:38:54 by mechane          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap::takeDamage(unsigned int amount)
{
	...
	else
	{
		_Hit_point -= amount;
		if (_Hit_point > 0)
        	std::cout << "ClapTrap : " <<  _name << " takes " << amount << " damage and has " << _Hit_point << " hit points left !" << std::endl;
		else
		{
        	_Hit_point = 0;
        	std::cout << "ClapTrap : " <<  _name << " takes " << amount << " damage and has been defeated " << std::endl;
		}
	}
}
...
{
	if (_Hit_point == 100)
        std::cout << "ClapTrap " << _name << " can't be repaired any further. Its hit points are already at the maximum value : " << _Hit_point << std::endl;
	else
	{
		if (_Energy_point == 0)
		...
		else
		{
			...
			if (_Hit_point > 100)
    	    	_Hit_point = 100;
    		std::cout << "ClapTrap : " << _name <<  " is repaired by " << amount << " hit points and has " << _Hit_point << " hit points remaining." << std::endl;
		}
	}
}
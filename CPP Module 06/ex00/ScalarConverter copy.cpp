...
bool	ScalarConverter::isSpecialCase()
{
...
bool	ScalarConverter::isSpecialCaseFloat()
{
...
bool	ScalarConverter::isSpecialCaseDouble()
{
...
bool	ScalarConverter::charDisplayable( void )
{
	if (this->_char < 32)
		return (false);
	return (true);
